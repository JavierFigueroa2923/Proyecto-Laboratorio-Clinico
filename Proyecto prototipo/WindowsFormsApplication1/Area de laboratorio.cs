...
namespace WindowsFormsApplication1
{
    public partial class Area_de_laboratorio : Form
    {
        ...
        {
            try {
                if (txt_desc_area.Text == "" || txt_id_lab.Text == "")
                {
                ...
                else
                {
                    ...
                    {
                        Conexionmysql.ObtenerConexion();
                        String query2 = "UPDATE area_laboratorio SET descripcion_ar_lab='" + txt_desc_area.Text + "' WHERE pk_id_area_lab='" + Codigo + "';";
                    ...
                    {
                        Conexionmysql.ObtenerConexion();
                        String Query = "INSERT INTO area_laboratorio (pk_id_lab, descripcion_ar_lab) VALUES ('" + Convert.ToDouble(txt_id_lab.Text) + "','" + txt_desc_area.Text + "') ";
        ...
        private void btn_actlz_area_Click(object sender, EventArgs e)
        {
            try {
                ...
                txt_desc_area.Text = this.dgv_area_labs.CurrentRow.Cells[1].Value.ToString();
        ...
        private void txt_desc_area_TextChanged(object sender, EventArgs e)
        {

        }

        private void txt_desc_area_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            {
                e.SuppressKeyPress = true;
