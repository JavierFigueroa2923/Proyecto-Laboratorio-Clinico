...
namespace Proyecto
{
    public partial class actualizar_empleadocs : Form
    {
        ...
        private void actualizar_empleadocs_Load(object sender, EventArgs e)
        {
            {
                server = "localhost";
                database = "grimpsa";
                ...
                {
                    MySqlDataAdapter a = new MySqlDataAdapter("SELECT empleado.cod_empleado AS codigo, nombre, apellido, direccion, correo_electronico,no_telefono FROM empleado left join  correo_electronico ON empleado.cod_empleado = correo_electronico.cod_empleado left join telefono on correo_electronico.cod_empleado = telefono.cod_empleado", conexion);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                String consulta2 = "UPDATE grimpsa.telefono set no_telefono= '" + this.textBox3.Text + "' where cod_empleado ='" + this.textBox1.Text + "';";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                String consulta3 = "UPDATE grimpsa.correo_electronico set correo_electronico= '" + this.textBox4.Text + "' where cod_empleado ='" + this.textBox1.Text + "';";
